...
**How to try it:** open [01 Subfolder link fix](<./01 Subfolder link fix.md>) and click the link inside it. The note is created in the folder your settings say it should be, not blindly at the vault root. Then open [02 Relative link fix](<./02 Relative link fix.md>) to see the out-of-vault case handled cleanly.

## Feature

- [01 Subfolder link fix](<./01 Subfolder link fix.md>)
- [02 Relative link fix](<./02 Relative link fix.md>)
- [03 Current note folder](<./03 Current note folder.md>)

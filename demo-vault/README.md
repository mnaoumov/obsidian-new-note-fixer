...
- **Otherwise**, download `new-note-fixer-demo-vault.zip` from the [plugin releases](https://github.com/mnaoumov/obsidian-new-note-fixer/releases), unzip it, and in Obsidian choose `Manage vaults...` → `Open folder as vault` → select the `new-note-fixer-demo-vault-<version>` folder it unzips into.
